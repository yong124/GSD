...
- [BIDIRECTIONAL_PIPELINE.md](/G:/GSD/content/docs/system/core/BIDIRECTIONAL_PIPELINE.md)

## scenario

스토리 구조, 챕터 설계, 밀도 원칙 문서.

- [SCENARIO_STORY_BIBLE.md](/G:/GSD/content/docs/system/scenario/SCENARIO_STORY_BIBLE.md)
- [CH1_CH3_DATA_DESIGN.md](/G:/GSD/content/docs/system/scenario/CH1_CH3_DATA_DESIGN.md)
- [SCENARIO_DENSITY_PRINCIPLES.md](/G:/GSD/content/docs/system/scenario/SCENARIO_DENSITY_PRINCIPLES.md)

## writing

대사/문체/시대감 관련 문서.

- [DIALOGUE_PERIOD_TONE_GUIDE.md](/G:/GSD/content/docs/system/writing/DIALOGUE_PERIOD_TONE_GUIDE.md)

## characters

캐릭터별 아크 및 관계 해석 문서.

- [CHARACTER_ARCS_INDEX.md](/G:/GSD/content/docs/system/characters/CHARACTER_ARCS_INDEX.md)
- [REL_INDEX.md](/G:/GSD/content/docs/system/characters/REL_INDEX.md)
