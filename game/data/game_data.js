  ...
  "scenes": {
    ...
    "ch2_hospital_a": {
      ...
      "dialogues": [
        ...
        {
          "order": 7,
          "text": "사람? 하하… 그분 앞에선 다 비슷해. 그릇이 되거나, 재가 되거나, 기록에서 문째 뜯겨 나가거나.",
          "style": "crazy",
          "speaker_id": "Ipangyu",
          "emotion_type": "Crazy",
          "standing_slot": "Center",
    ...
    "ch2_well": {
      ...
      "dialogues": [
        ...
        {
          "order": 10,
          "text": "좋군요. 대신 이제부턴 혼자 움직이지 마십시오. 누가 없어졌는지 입 다무는 사람들 틈에선, 같이 본 사람이 하나라도 더 있어야 하니까.",
          "style": "normal",
          "speaker_id": "Yuu",
          "emotion_type": "Tense",
          "standing_slot": "Right",
    ...
    "ch6_path_b": {
      ...
      "dialogues": [
        ...
        {
          "order": 2,
          "text": "유웅룡은 이해심을 향해 달려가며, 지난 기사들에서 지워진 문장들을 머릿속으로 되짚는다. 덮인 문장이 많을수록, 이번엔 몸으로라도 그 빈칸을 메워야 한다고 느낀다.",
          "style": "narration"
        },
        {
          "order": 3,
    ...
    "ch6_ending_b": {
      ...
      "dialogues": [
        {
          "order": 1,
          "text": "유웅룡이 이해심을 향해 달려든다. 짧은 충돌. 이해심이 쓰러지고 의식의 결이 끊긴다. 사람 몸으로 겨우 멈춘 의식은 끝내 아름답지도 장엄하지도 않다. 그저 비싼 대가를 치른 범죄 현장처럼 남는다.",
          "style": "narration"
        },
        {
          "order": 2,
